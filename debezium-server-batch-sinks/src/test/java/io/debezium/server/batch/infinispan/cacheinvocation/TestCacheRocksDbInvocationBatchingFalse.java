...
@TestProfile(TestCacheRocksDbInvocationBatchingFalseProfile.class)
public class TestCacheRocksDbInvocationBatchingFalse extends BaseSparkTest {
  ...
  public void testPerformance() throws Exception {
    ...
    loadDataToDummyPerformanceTable(300000);
  }
}
