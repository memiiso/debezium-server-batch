...
import io.debezium.server.batch.common.*;
...
@TestProfile(BatchSparkHudiChangeConsumerUpsertTestProfile.class)
public class BatchSparkHudiChangeConsumerUpsertTest extends BaseSparkTest {

  @Inject
  BatchSparkHudiChangeConsumer consumer;
