...
/**
 * WORKAROUND OF DEPENDENCY CONFLICT COPIED FROM HTTPCLIENT-4.5.13
 * FOLLOWING two dependencies are having conflict, hudi bundle loads the class but its bundled with older version
 * of httpclient library and missing the method
 * <p>
